...
class CreateTRiwayatGajiBerkala extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('t_riwayat_gaji_berkala', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('t_riwayat_gaji_berkala');
    }
}
