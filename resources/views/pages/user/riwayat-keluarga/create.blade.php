...
<div class="col-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Tambah Riwayat Keluarga</h4>
        </div>
        <div class="card-body">
        <form class="form"  id="dataForm" action="{{ route('riwayat-keluarga.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="form-label" for="basic-icon-default-post">Hubungan Keluarga</label>
                        <select name="id_hub_kepala_keluarga" id="id_hub_kepala_keluarga"  class="required form-control dt-post  @error('id_hub_kepala_keluarga') is-invalid @enderror ">
                            ...
                            <option value="{{$row->id_hub_kepala_keluarga}}"  >{{ $row->hub_kepala_keluarga	 }}</option> 
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nama_lengkap" class="form-control @error('nama_lengkap') is-invalid @enderror " name="nama_lengkap"  />
                    @error('nama_lengkap')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="tgl_lahir" class="required form-control @error('tgl_lahir') is-invalid @enderror " name="tgl_lahir" />
                    @error('tgl_lahir')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="kota_lahir" class="form-control @error('kota_lahir') is-invalid @enderror " name="kota_lahir"  />
                    @error('kota_lahir')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-md-12 col-12">
                    <div class="form-group row"> 
                        ...
                        <div class="custom-control custom-radio ">
                            <input type="radio" id="validationRadiojq1" name="jenis_kelamin" value="Laki-Laki" class="required custom-control-input">
                            <label class="custom-control-label" for="validationRadiojq1">Laki-Laki</label>
                        </div>
                        
                        <div class="custom-control custom-radio  ml-1">
                            <input type="radio" id="validationRadiojq2" name="jenis_kelamin" value="Perempuan"  class="required custom-control-input">
                ...
                <div class="col-md-12 col-12">
                <div class="form-group">
                    <label for="dokumen_riwayat_keluarga">Dokumen</label>
                    <input type="file" id="dokumen_riwayat_keluarga" class="form-control @error('dokumen_riwayat_keluarga') is-invalid @enderror " name="dokumen_riwayat_keluarga" />
