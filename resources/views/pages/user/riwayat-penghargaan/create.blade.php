...
<div class="col-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Tambah Riwayat Penghargaan</h4>
        </div>
        <div class="card-body">
        <form class="form"  id="dataForm" action="{{ route('riwayat-penghargaan.store') }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="nama_tanda_jasa_penghargaan-id-column" class="required form-control @error('nama_tanda_jasa_penghargaan') is-invalid @enderror"name="nama_tanda_jasa_penghargaan"   />
                    ...
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="no_piagam-id-column" class="required form-control @error('no_piagam') is-invalid @enderror" name="no_piagam"  />
                            @error('no_piagam')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="date" id="tanggal_piagam-id-column" class="required form-control @error('tanggal_piagam') is-invalid @enderror" name="tanggal_piagam"  />
                    ...
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="badan_instansi_yg_memberikan-id-column" class="required form-control @error('badan_instansi_yg_memberikan') is-invalid @enderror" name="badan_instansi_yg_memberikan"  />
