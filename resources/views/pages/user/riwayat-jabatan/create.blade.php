...
<div class="col-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Tambah Riwayat Jabatan</h4>
        </div>
        <div class="card-body">
        <form class="form"  id="dataForm" action="{{ route('riwayat-jabatan.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <input type="date" name="tgl_tmt" id="tgl_tmt" class="form-control">
                            @error('tgl_tmt')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-md-4 col-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="keterangan_jabatan" id="keterangan_jabatan" class="form-control">
