...
<div class="col-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Tambah Riwayat Asesmen Kompetensi Pegawai </h4>
        </div>
        <div class="card-body">
        <form class="form"  id="dataForm" action="{{ route('riwayat-asesmen-kompetensi.store') }}" method="post"  enctype="multipart/form-data">
                ...
                <div class="row">
                     <div class="col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="date" id="tanggal-id-column" class="required form-control @error('tanggal_asesmen') is-invalid @enderror " name="tanggal_asesmen"  />
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <input type="number" id="nilai_kompetensi-id-column" class="form-control required @error('nilai_kompetensi') is-invalid @enderror " name="nilai_kompetensi" maxlength="20" />
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <input type="number" id="nilai_potensi-id-column" class="form-control required @error('nilai_potensi') is-invalid @enderror " name="nilai_potensi" maxlength="20" />
                            @error('nilai_potensi')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="file" id="dokumen_asesmen-id-column" class="required form-control @error('dokumen_asesmen') is-invalid @enderror " name="dokumen_asesmen"  />
