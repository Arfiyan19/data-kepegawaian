...
<div class="col-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Edit Riwayat Tempat Tinggal</h4>
        </div>
        <div class="card-body">
        <form class="form"  id="dataForm" action="{{ route('riwayat-tempat-tinggal.update',$data->id) }}" method="post">
                @csrf
                @method('put')
                <div class="row">
                ...
                <div class="form-group">
                    <label class="form-label" for="basic-icon-default-post">Provinsi</label>
                            ...
                            <option value="{{$row->id}}"  {{ $row->id  == $data->provinsi_id ? 'selected' : '' }} >{{ $row->name }}</option> 
                            @endforeach
                        </select>
                        @error('id')
                ...
                <div class="form-group">
                        ...
                        <option  value="{{$data->kabupaten_id}}"  selected >{{ $data->nama_provinsi  }}</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-12 col-12"> 
                <div class="form-group">
                        ...
                        <option  value="{{$data->kecapatan_id}}"  selected >{{ $data->nama_kecapatan  }}</option>
                ...
                <div class="form-group">
                        ...
                        <option  value="{{$data->kelurahan_id}}"  selected >{{ $data->nama_kelurahan  }}</option>
                    ...
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="alamat" value="{{ $data->alamat }}"  id="-id-column" class="required form-control @error('tempat_kedudukan_organisasi') is-invalid @enderror " />
                        </div>
                    </div>
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                            <label for="tanggal_mulai-id-column">Tanggal Mulai</label>
                            <input type="date" id="tanggal_mulai-id-column" value="{{ $data->tanggal_mulai }}" class="required form-control @error('tanggal_mulai') is-invalid @enderror "name="tanggal_mulai"   />
                    ...
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="date" id="tanggal_berakhir-id-column" value="{{ $data->tanggal_berakhir }}" class="required form-control @error('tanggal_mulai') is-invalid @enderror" name="tanggal_berakhir"  />
                        </div>
                    </div>
