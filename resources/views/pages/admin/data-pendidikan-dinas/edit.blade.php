  ...
  <div class="card-body">
    ...
    <table class="table">
        <tr>
            ...
            <td>{{ $data->lembaga_penyelenggara }}</td>
        </tr>
        <tr>
            <td>Lokasi :</td>
            <td>{{ $data->lokasi }}</td>
        ...
        <tr>
            <td>No sk kelulusan :</td>
            <td>{{ $data->no_sk_kelulusan }}</td>
        </tr><tr>
            <td>Jam latihan :</td>
            <td>{{ $data->tanggal_berakhir }}</td>
        </tr><tr>
            <td>Tangal sk Kelulusan :</td>
            <td>{{ $data->tangal_sk_kelulusan }}</td>
        </tr><tr>
            <td>No sertifikat :</td>
            <td>{{ $data->no_sertifikat }}</td>
        </tr>
        <tr>
            <td>Tanggal no sertifikat :</td>
            <td>{{ $data->tanggal_no_sertifikat }}</td>
        </tr>
        <tr>
            <td>Jenis diklat :</td>
            <td>{{ $data->jenis_diklat }}</td>
        </tr>
        <form class="form"  id="dataForm" action="{{ route('data-asesmen-kompetensi.update',$data->id) }}" method="post">
            @method('PUT')
    
                @csrf
              <input type="hidden" value="{{ $data->lembaga_penyelenggara }} {{ $data->lokasi }}" name="title">
