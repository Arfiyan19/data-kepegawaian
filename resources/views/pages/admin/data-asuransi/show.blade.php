...
@extends('layouts.app')
@section('title',' Data Asuransi:'.  $dataPegawai->nama_pegawai )
    ...
    <div class="col-12">
        ...
        <div class="breadcrumb-wrapper">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url('admin/data-asuransi') }}"> Data Asuransi </a>
                </li>  
...
<div class="card">
    <div class="card-header border-bottom p-1"> 
        <div  class="head-label"><h6 class="mb-0">Data Asuransi : {{ $dataPegawai->nama_pegawai }}</h6></div> 
    </div>
    <div class="container">
        ...
        <tbody>
           ...
           @if($row->read_at == 0)
            ...
            <td>
               ...
               <a href="{{ route('data-asuransi.edit', $row->id_asuransi) }}"  class="btn btn-icon rounded-circle btn-outline-primary"><i data-feather='check'></i></a>
