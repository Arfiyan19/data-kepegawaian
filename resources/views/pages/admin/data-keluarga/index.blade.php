...
<div class="row breadcrumbs-top">
    <div class="col-12">
        <h2 class="content-header-title float-left mb-0">Kelola Data Keluarga</h2>
        <div class="breadcrumb-wrapper">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('admin/home') }}">Home</a>
                </li> 
                <li class="breadcrumb-item active">Kelola Data Keluarga
                </li>
            </ol>
        </div>
    </div>
...
<div class="card">
    ...
    <table class="data-table text-center table" id="dataTables" >
        ...
        <tbody>
            ...
            <td>
              <a href="{{ route('data-keluarga.show', $row->user_id) }}"  class="btn btn-icon rounded-circle btn-outline-primary"><i data-feather='eye'></i></a>            
            </td>
            </tr>
            @endforeach
        </tbody>
