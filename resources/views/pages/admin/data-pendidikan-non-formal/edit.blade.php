...
<div class="row breadcrumbs-top">
    <div class="col-12">
        <h2 class="content-header-title float-left mb-0">Validasi Data Pendidakan Non Formal</h2>
...
<div class="card col-md-12" >
  <div class="card-body">
    ...
    <table class="table">
        <tr>
            <td>Nama Pendidkan Formal  :</td>
            <td>{{ $data->nama_pendidikan_non_formal }}</td>
        </tr>
        <tr>
            <td>Penyelenggara Sponsor Lembaga :</td>
            <td>{{ $data->penyelenggara_sponsor_lembaga }}</td>
        </tr>
        <tr>
            <td>Tanggal Mulai :</td>
        ...
        <form class="form"  id="dataForm" action="{{ route('data-pendidikan-non-formal.update',$data->id) }}" method="post">
            @method('PUT')
    
                @csrf
              <input type="hidden" value="{{ $data->nama_pendidikan_non_formal }}  " name="title">
    ...
    <div class="col-12">
        ...
        <a  href="{{ route('data-pendidikan-non-formal.show', $dataPegawai->user_id) }}"  class="btn btn-outline-secondary">Kembali</a>
