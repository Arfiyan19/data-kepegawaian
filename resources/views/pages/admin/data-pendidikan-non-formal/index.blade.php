@extends('layouts.app')
@section('title','Kelola Data Pendidikan non foraml')
...
<div class="card">
    ...
    <table class="data-table text-center table" id="dataTables" >
        ...
        <tbody>
            ...
            <td>
              <a href="{{ route('data-pendidikan-non-formal.show', $row->user_id) }}"  class="btn btn-icon rounded-circle btn-outline-primary"><i data-feather='eye'></i></a>            
            </td>
            </tr>
            @endforeach
        </tbody>
