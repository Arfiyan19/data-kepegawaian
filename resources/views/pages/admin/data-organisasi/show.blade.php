    ...
    <div class="col-12">
        ...
        <div class="breadcrumb-wrapper">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url('admin/data-cuti') }}"> Data Organisasi </a>
                </li>  
...
<div class="card">
    <div class="card-header border-bottom p-1"> 
        <div  class="head-label"><h3 class="mb-0">Data Organisasi : {{ $dataPegawai->nama_pegawai }}</h3></div> 
    </div>
    <div class="container">
    <table class="data-table table" id="dataTables" >
        ...
        @if($row->read_at == 0)
            ...
            <td>
            <a href="{{ route('data-organisasi.edit', $row->id_riwayat) }}"  class="btn btn-icon rounded-circle btn-outline-primary"><i data-feather='check'></i></a>
